...
"GUI_MILES": "Μίλια",
// mapping
"GUI_MAPPING_TOOLS": "Εργαλεία Χαρτογραφίας",
...
"DIRECTION_10":"Ευθεία <b>%d</b>[ στην <b>%s</b>]",
...
"NOTIFICATION_MAINTENANCE_BODY":	"Ο ιστότοπος OSRM είναι εκτός για προγραμματισμένη συντήρηση. " + 
									...
									"<br/><br/><br/>[OSRM]",
"NOTIFICATION_LOCALIZATION_HEADER":	"Το ξέρετε? Μπορείτε να αλλλάξετε τη γλώσσα εμφάνισης.",
...
"NOTIFICATION_CLICKING_HEADER":		"Το ξέρετε? Μπορείτε να κάνετε κλικ στο χάρτη και να θέσετε δείκτες δρομολογίου.",
...
"NOTIFICATION_DRAGGING_HEADER":		"Το ξέρετε? Μπορείτε να σύρετε κάθε δείκτη δρομολογίου στο χάρτη.",
